Feature: User can comment on an item
...
Scenario: Comment on an Item
  ...
  When I fill in "Add Comment" with "Works well, but needs sharpening"
  And I press "Submit"
  Then I should see "Comments Works well, but needs sharpening"